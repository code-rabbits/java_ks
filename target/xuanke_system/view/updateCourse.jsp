...
<div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
            ...
            <!--    修改课程的表单-->
            <form class="form-horizontal" action="${pageContext.request.contextPath }/updateCourse" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="cname" value="${course.cname}"  required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="credit" value="${course.credit}" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="open">
                            <option value="大学一年级第一学期" selected="selected">大学一年级第一学期</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="number" value="${course.number}"  required>
                    </div>
                </div>
